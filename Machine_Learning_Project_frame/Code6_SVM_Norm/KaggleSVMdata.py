...
from KaggleSVMConvert import KaggleConvertToNorm
...
def load_data() -> dict:
    ...
    train_data_path = './project_data/data/train_norm.csv'
    test_data_path = './project_data/data/test_norm.csv'
    anon_data_path = './project_data/data/evalanon_norm.csv'
